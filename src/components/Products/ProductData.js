...
const products = [
  ...
  },
  {
    ...
    description:
      'High Quality granules of all grades (N1, N2, BLACK, MIX … etc) are imported by us which has several applications like Blow Film, Tarpaulin industry, Agricultural pipes, Garden pipes, etc.',
  },
  {
    id: 4,
    image: CCP,
